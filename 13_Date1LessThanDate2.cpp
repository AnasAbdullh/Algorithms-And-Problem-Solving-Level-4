...
int main()
{
    ...
    short result1 = NumberOfDaysFromTheBeginingOfTheYear(Date1.Day,Date1.Month,Date1.Year);
    short result2 = NumberOfDaysFromTheBeginingOfTheYear(Date2.Day,Date2.Month,Date2.Year);
