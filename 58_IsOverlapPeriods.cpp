...
{
    stPeriod Period;
    cout << "Start Periods" << endl;
    Period.StartPeriod = ReadFullDate();
    cout << "End Periods" << endl;
    Period.EndPeriod = ReadFullDate();
    return Period;
}

bool IsPeroiodsOverlap(stPeriod Period1, stPeriod Period2)
{
    if(IsDate1BeforeDate2(Period1.EndPeriod,Period2.StartPeriod) && !IsDate1EqualDate2(Period1.EndPeriod,Period2.StartPeriod))
    {
        return true;
...
int main()
{
    ...
    if(IsPeroiodsOverlap(Period1,Period1))
    {
        cout << "Yes Periods Overlap\n";
    } else {
        cout << "Not Periods Overlap\n";
    }
